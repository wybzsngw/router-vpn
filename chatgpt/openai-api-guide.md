...
> 📄 本文对应 HTML 页面：[OpenAI API 指南](../docs/pages/openai-api-guide.html)
...
1. **OpenAI 账号**：与 ChatGPT 共用同一账号
2. **能稳定打开** <https://platform.openai.com>
...
A：主要两个：一是能否稳定打开 OpenAI 平台，二是容易混淆 Plus 和 API 的关系（两者独立）。
...
📌 **相关教程**：[Plus 充值](./chatgpt-plus-guide.md) · [Cursor 指南](../cursor/cursor-guide.md)
