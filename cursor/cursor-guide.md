...
Cursor 是一个带 AI 的代码编辑器。你跟它说话，它帮你写代码、改网站、解决问题。

**你不需要懂编程**——就像你雇了一个全职程序员：你说需求，它来干活，你来验收。
...
| 📝 写博客/内容 | 让 AI 写文章、排版、生成摘要 |
| 🔧 修网站 Bug | 复制报错给 AI，它告诉你哪里错了怎么改 |
| 📂 批量处理文件 | 让 AI 写脚本批量重命名、格式转换 |
| 🚀 部署服务器应用 | AI 帮你写部署脚本，服务器配置一起搞定 |
| 💬 看英文技术文档 | 把英文文档丢给它，让它用中文解释给你听 |
