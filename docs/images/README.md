# 华硕路由器 Clash 翻墙教程图片资源

本目录包含华硕路由器 Clash/梅林固件教程的相关图片资源。华硕相关截图与机型图已归入 **`asus/`** 子目录。

## 目录结构

- **`asus/`** — 华硕路由器教程专用：机型示意、梅林刷机、Fancyss 等
- **`common/`**、**`linux/`**、**`macos/`** 等 — 其他平台教程图片
...
- `asus-1.png` — 华硕 RT-AC86U 入门级机型示意
- `asus-2.png` — 华硕 RT-AX86U PRO 机型示意
- `asus-3.png` — 华硕 RT-BE86U 高端旗舰机型示意

**已归入 asus/ 的图片：**

- `asus-rt-ac86u.png`、`asus-rt-ax86u-pro.png`、`RT-BE86U.png` — 机型图（可与 asus-1/2/3 对应使用）
- `fancyss-1.png`～`fancyss-6.png` — Fancyss 科学上网插件安装与配置截图

### 1. 硬件介绍（根目录或 asus/）

- `asus-rt-ax86u-pro.png` - 华硕 RT-AX86U PRO 路由器外观图（见 asus/）
