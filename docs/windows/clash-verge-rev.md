...
![GitHub 发布页](../../images/windows/clash-verge-releases.png)
...
![选择 x64 安装包](../../images/windows/clash-verge-download.png)
...
![安装向导](../../images/windows/clash-verge-install.png)

### 4. 验证安装

启动后应看到 Clash Verge Rev 主界面，包含 **Profiles**、**Proxies**、**Logs** 等标签页。

![主界面](../../images/windows/clash-verge-main.png)
...
![导入订阅](../../images/windows/clash-verge-import.png)

### 3. 选择配置

导入成功后，配置列表会出现新条目。点击该配置名称，使其变为当前使用的配置（高亮显示）。

![选择配置](../../images/windows/clash-verge-select-profile.png)
...
![系统代理开关](../../images/windows/clash-verge-system-proxy.png)
...
![代理模式选择](../../images/windows/clash-verge-mode.png)
...
![TUN 模式开关](../../images/windows/clash-verge-tun.png)
...
![开机自启设置](../../images/windows/clash-verge-autostart.png)
...
- [订阅与机场入门](../../pages/clash-subscription-guide.html)（如有）
