...
- **不适合**：想自己导入多个订阅、改规则、玩 TUN 模式 → 请使用 [Clash Verge Rev](../windows/clash-verge-rev.md)、[华硕梅林固件刷机教程](../asus-router/asus-merlin-flash.md)、OpenClash 等通用客户端。
...
| [华硕梅林固件刷机教程](../asus-router/asus-merlin-flash.md) / OpenClash | 路由器全屋网络方案，一次配置全家用 | 排障成本更高 | 软路由、华硕梅林、旁路由用户 |
...
- [华硕路由器梅林固件刷机教程](../asus-router/asus-merlin-flash.md)：路由器刷机与软件中心准备
